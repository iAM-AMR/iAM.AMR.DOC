...
The sawmill package
~~~~~~~~~~~~~~~~~~~
The sawmill package is an R package which processes queries extracted from the CEDAR database. The package is fully documented in-line using Roxygen2, and is outlined on the :ref:`sawmill main page <02_project/Sawmill:The sawmill R Package>`.
